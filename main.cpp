/*
DosSiete
Práctica #3: Variables Globales y Variables Locales
...
float total, float gananciaBruta, float isr, float gananciaNeta, float isrPagar,
float gastoIva, float ivaPagar, float ingresoTotal, float gastoTotal){
    cout<<fixed<<setprecision(2)<<"Cálculo de impuestos anual"<<endl<<endl
...
int menuPrincipal(){
    ...
    cout<<"6. Cálculo de impuestos anual"<<endl;
    cout<<"7. Guardar en archivo"<<endl;
    cout<<"8. Salir"<<endl;
    cout<<endl<<"Opción: "<<endl;
    cin>>opcionMenu;
    return opcionMenu;
}
void capturarMes(){
